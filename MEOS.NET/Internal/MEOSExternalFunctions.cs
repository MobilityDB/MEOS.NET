...
namespace MEOS.NET.Internal
{
    internal partial class MEOSExposedFunctions
    {
        ...
        private class MEOSExternalFunctions
        {
            ...
            [DllImport(DllPath, CallingConvention = CallingConvention.Cdecl)]
            public static extern void meos_initialize_error_handler(ErrorHandlingMethod err_handler);
            ...
            [DllImport(DllPath, CallingConvention = CallingConvention.Cdecl)]
            public static extern void meos_initialize(string tz_str, ErrorHandlingMethod err_handler);
